...
**General:** The herein code is the official bioinformatic pipeline to process fastq files generated by CAST-Seq. Both original CAST-Seq and T-CAST can be processed.
...
**--pipeline** name of the pipeline you want to use. So far, "crispr" and "talen" are available for CAST-Seq and T-CAST respectively.<br/>
