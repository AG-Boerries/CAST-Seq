...
circlizePipelineDoubleNickase <- function(siteFile, zoom.size = 50000, label = FALSE,
                                  PV.cutoff = 0.05,
                                  bestScore.cutoff = NULL, bestFlank.cutoff = 25,
                                  showNBS = TRUE,
                                  gene.bed = NULL, ots.bed = NULL, 
...
library(GenomicRanges)
  ...
  # TEST DOUBLE NICKASE
  #siteFile <- file.path("~/cluster/cluster/CASTSeq/pipelineGit/samples_overlap/Nickase_Julia/COL7A1-g1g2D10A_OVL1/COL7A1-g1g2D10A_OVL1_FINAL.xlsx")
  #siteFile <- file.path("~/cluster/cluster/CASTSeq/pipelineGit/samples/Nickase_Julia/gRNA_2/COL7A1-2-D10Ag2/results/guide_aln/COL7A1-2-D10Ag2_w250_FINAL.xlsx")
  siteFile <- file.path("~/cluster/cluster/CASTSeq/pipelineGit/samples/Nickase_Julia/gRNA_1_2/COL7A1-g1g2D10A/results/guide_aln/COL7A1-g1g2D10A_w250_FINAL.xlsx")
  ...
  bestFlank.cutoff = 25
  gene.bed = NULL
  #ots.bed = file.path("~/cluster/cluster/CASTSeq/pipelineGit/samples/Nickase_Julia/gRNA_1_2/COL7A1-2-D10Ag1g2/data/ots.bed")
  #ots.bed = file.path("~/cluster/cluster/CASTSeq/pipelineGit/samples/Nickase_Julia/gRNA_2/COL7A1-2-D10Ag2/data/ots.bed")
  ots.bed = file.path("~/cluster/cluster/CASTSeq/pipelineGit/samples/Nickase_Julia/gRNA_1_2/COL7A1-g1g2D10A/data/ots.bed")
  realigned = FALSE
  species <- "hg38"
  outFile <- "~/tmp/COL7A1-2-D10Ag2_circlize.pdf"
  
  circlizePipelineDoubleNickase(siteFile,
                                zoom.size = 25000, label = FALSE, 
                                PV.cutoff = 0.05,
                                bestScore.cutoff = NULL, bestFlank.cutoff = 25,
                                showNBS = TRUE,
