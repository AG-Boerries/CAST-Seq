...
runPipeline_CRISPR2 <- function()
{
  ...
  ################     DEFINE GROUPS    ################ 
  print("################     DEFINE GROUPS    ################ ")
  assignGroups2(file.path(ovlD, paste0(projectName, "_FLANK.xlsx")),
                file.path(randomD, paste0(randomName, "_FLANK.xlsx")),
  ...
  guidePlot1(file.path(ovlD, paste0(projectName, "_GROUP.xlsx")),
             file.path(ovlD, paste0(projectName, "_ALN_RAW_heatmap.gRNA1.pdf")),
             score = NULL, pv = NULL, ref = refSeq1,
  ...
  guidePlot1(file.path(ovlD, paste0(projectName, "_GROUP.xlsx")),
             file.path(ovlD, paste0(projectName, "_ALN_heatmap.gRNA1.OMT.pdf")),
             score = NULL, pv = NULL, ref = refSeq1,
             OMTonly = TRUE,
             nbOvl = nb.ovl, nbSignif = nb.signif)# SELECTED ONLY
  
  guidePlot2(file.path(ovlD, paste0(projectName, "_GROUP.xlsx")),
             file.path(ovlD, paste0(projectName, "_ALN_RAW_heatmap.gRNA2.pdf")),
             score = NULL, pv = NULL, ref = refSeq2,
             nbOvl = NULL, nbSignif = NULL)# ALL
  ...
  guidePlot2(file.path(ovlD, paste0(projectName, "_GROUP.xlsx")),
             file.path(ovlD, paste0(projectName, "_ALN_heatmap.gRNA2.OMT.pdf")),
             score = NULL, pv = NULL, ref = refSeq2,
             OMTonly = TRUE,
             nbOvl = nb.ovl, nbSignif = nb.signif)# SELECTED ONLY
  
  # LOGO PLOT
  logoPlot1(file.path(ovlD, paste0(projectName, "_GROUP.xlsx")),
            file.path(ovlD, paste0(projectName, "_ALN_RAW_logo.gRNA1.pdf")),
            score = NULL, pv = NULL, ref = refSeq1,
            nbOvl = NULL, nbSignif = NULL)# ALL
  ...
  logoPlot2(file.path(ovlD, paste0(projectName, "_GROUP.xlsx")),
            file.path(ovlD, paste0(projectName, "_ALN_RAW_logo.gRNA2.pdf")),
            score = NULL, pv = NULL, ref = refSeq2,
            nbOvl = NULL, nbSignif = NULL)# ALL
