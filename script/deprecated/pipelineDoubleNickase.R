...
runPipelineDoubleNickase <- function()
{
  ...
  assignBestCombinationDoubleNickase(file.path(guideD, paste0(sampleName, "_w", w, "_aln_stat.xlsx")))	
  ...
  # ASSIGN THE BEST COMBINATION
  assignBestCombinationDoubleNickase(file.path(guideD, paste0(controlName, "_w", w, "_aln_stat.xlsx")))	
